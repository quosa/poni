    ...
    def _prepare_conn(self):
        ...
        for env_key in required_env:
            if not os.environ.get(env_key):
                self.log.warning("Could not find %s environment variable. This might be prove problematic unless have other ways to authenticate yourself (instance profile, credentials file, ...)", env_key)
